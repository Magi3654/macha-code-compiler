...
public class CompiladorLexer extends Lexer {
	...
	public static final int
		...
		NANU=8, DO=9, PPAEDA=10, EQUALS=11, PRINT=12, IF=13, ELSE=14, LOGIC=15, 
		MATH=16, BOOLEAN=17, STRING=18, CHAR=19, SUJJA=20, GEULSSI=21, CHINCHA=22, 
		GONG=23;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"NANU", "DO", "PPAEDA", "EQUALS", "PRINT", "IF", "ELSE", "LOGIC", "MATH", 
			"BOOLEAN", "STRING", "CHAR", "SUJJA", "GEULSSI", "CHINCHA", "GONG"
		};
	}
