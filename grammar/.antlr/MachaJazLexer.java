...
public class MachaJazLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"NANU", "DO", "PPAEDA", "EQUALS", "PORCENT", "SUMARIZER", "COMA", "PRINT", 
			"IF", "ELSE", "FOR", "WHILE", "LOGIC", "AND", "OR", "MATH", "BOOLEAN", 
	...
	public MachaJazLexer(CharStream input) {
		super(input);
