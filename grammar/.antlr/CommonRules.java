...
public class CommonRules extends Lexer {
	...
	public static final int
		CHICHAK=1, PR=2, GOPSSEM=3, NANU=4, DO=5, PPAEDA=6, GEULSSI=7, GONG=8;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CHICHAK", "PR", "GOPSSEM", "NANU", "DO", "PPAEDA", "GEULSSI", "GONG"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "CHICHAK", "PR", "GOPSSEM", "NANU", "DO", "PPAEDA", "GEULSSI", 
			"GONG"
		};
	}
