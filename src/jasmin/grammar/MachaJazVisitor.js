...
// This class defines a complete generic visitor for a parse tree produced by MachaJazParser.

export default class MachaJazVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by MachaJazParser#validAssign.
	visitValidAssign(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by MachaJazParser#invalidAssign.
	visitInvalidAssign(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by MachaJazParser#simpleAssign.
	...
	// Visit a parse tree produced by MachaJazParser#parentesis.
	visitParentesis(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by MachaJazParser#sujja.
	visitSujja(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by MachaJazParser#sumres.
	visitSumres(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by MachaJazParser#geulssi.
	visitGeulssi(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by MachaJazParser#muldiv.
	visitMuldiv(ctx) {
	  return this.visitChildren(ctx);
	}
